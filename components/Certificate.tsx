...
export default function AchievementsApp() {
  const achievements = [
    ...
    {
      id: 2,
      title: "Grastech Internship Certificate",
      description: "Completed a cybersecurity internship at Grastech, developing a Python-based port scanner and gaining hands-on experience in ethical hacking.",
      icon: Award,
      date: "16th june, 2025- 20th Aug, 2025",
      category: "Certification",
      color: "text-yellow-500",
      bgColor: "bg-yellow-500/10",
      pdfUrl: "/certificates/grastech_certificate.pdf",
    },
    // {
    //   id: 3,
